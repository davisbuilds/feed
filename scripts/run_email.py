...
def create_sample_digest() -> DailyDigest:
    ...
    articles = [
        Article(
            ...
            summary=(
                ...
                "experiences at scale while raising questions about authenticity "
        ...
        Article(
            ...
            category="Business",
            summary=(
                "New data reveals hybrid work is here to stay, with most companies "
                "settling on 2-3 office days per week as the new standard."
            ),
            key_takeaways=[
    ...
    categories = [
        CategoryDigest(
            ...
            articles=[articles[0]],
            synthesis=(
                "Today's tech coverage focuses on the transformative impact of AI "
        ...
        CategoryDigest(
            ...
            articles=[articles[1]],
            synthesis=(
                "Workplace trends continue to evolve as companies find their "
                "footing in the post-pandemic era."
            ),
            top_takeaways=[
